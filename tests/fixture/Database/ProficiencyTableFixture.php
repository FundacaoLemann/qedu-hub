...
INSERT INTO `fact_proficiency` (
	...
	(1009, 30945, 113, 25.02, 7.30, 5.21, 12.51, 4.17, 3.13),
	(1012, 30945, 113, 36.01, 12.19, 3.13, 20.69, 11.19, 1.00),
	(1010, 30945, 113, 25.02, 9.38, 4.17, 11.47, 7.30, 2.09),
	(1013, 30945, 113, 36.01, 1.06, 4.19, 30.76, 1.06, 0.00);
SQL
            )->execute();
    }
}
