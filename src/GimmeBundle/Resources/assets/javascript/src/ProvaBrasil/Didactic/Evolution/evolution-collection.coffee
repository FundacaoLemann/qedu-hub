...
EvolutionBlockView = Backbone.View.extend
  ...
  changeValues: () ->    
    ...
    # Dados 2011        
    if evolution['edition-4']
      @changeEditionBlock elEditions[0], evolution['edition-4']
    else
      @changeEditionBlockEmpty elEditions[0]

    # Dados 2013
    if evolution['growth-5']
      @changeGrowthBlock elGrowth[0], evolution['growth-5']
    else
      @changeGrowthBlockEmpty elGrowth[0]

    if evolution['edition-5']
      @changeEditionBlock elEditions[1], evolution['edition-5']
    else
      @changeEditionBlockEmpty elEditions[1]

    # Dados 2015
    if evolution['growth-6']
      @changeGrowthBlock elGrowth[1], evolution['growth-6']
    else
      @changeGrowthBlockEmpty elGrowth[1]

    if evolution['edition-6']
      @changeEditionBlock elEditions[2], evolution['edition-6']
    else
